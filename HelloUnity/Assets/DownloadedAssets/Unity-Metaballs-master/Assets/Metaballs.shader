Shader "Unlit/Metaballs"
{
    ...
    SubShader
    {
		// Gavin Edits: Want transparent overlay, and alpha blending
        Tags { 
        ...
        Pass
        {
            ...
            fixed4 frag (v2f i) : SV_Target
            {
				...
				//Gavin edit: need alpha for screen overlay
				float alpha = 1.0;
				...
				//-----------------------------------------------------
					...
					{
						//Gavin edit: if we have no intersection, set alpha to zero
						alpha = 0.0;
					}
					tot += col;
				}
				...
				//Gavin edit: setting alpha to final result
				//fragColor = 
